const menuData = [
  {id:"shawarma", title:"ركن الشاورما", items:[
    {name:"ساندوتش شاورما فراخ", prices:[["صغير",55],["وسط",75],["صاروخ",105],["عملاق",160]],img:"assets/shawarma.jpg"},
  ...
  {id:"grilled-chicken", title:"الفراخ المشوية", items:[
    {name:"فرخة مشوية مع الأرز البسمتي",prices:[["وجبة",390]],img:"assets/grilled-chicken.jpg"},
